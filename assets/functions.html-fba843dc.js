import{_ as n,p as s,q as a,a1 as t}from"./framework-c4f3d865.js";const p={},o=t(`<h1 id="部分功能实现" tabindex="-1"><a class="header-anchor" href="#部分功能实现" aria-hidden="true">#</a> 部分功能实现</h1><h2 id="audiocontext-播放音频" tabindex="-1"><a class="header-anchor" href="#audiocontext-播放音频" aria-hidden="true">#</a> AudioContext 播放音频</h2><div class="language-typescript" data-ext="ts"><pre class="language-typescript"><code><span class="token keyword">const</span> audioContext<span class="token operator">:</span> AudioContext <span class="token operator">=</span> <span class="token keyword">new</span> <span class="token class-name">AudioContext</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
