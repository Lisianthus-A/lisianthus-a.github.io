import{_ as s,p as a,q as n,a1 as e}from"./framework-c4f3d865.js";const t={},p=e(`<h1 id="vuepress" tabindex="-1"><a class="header-anchor" href="#vuepress" aria-hidden="true">#</a> VuePress</h1><h2 id="使用-vuepress-搭建博客" tabindex="-1"><a class="header-anchor" href="#使用-vuepress-搭建博客" aria-hidden="true">#</a> 使用 VuePress 搭建博客</h2><blockquote><p>以下内容适用于 vuepress@1.7.1</p></blockquote><h3 id="hello-world" tabindex="-1"><a class="header-anchor" href="#hello-world" aria-hidden="true">#</a> Hello, World</h3><ol><li>首先创建新文件夹，命名为 blog，在 blog 目录下运行 <code>npm init -y</code> 初始化。</li><li>安装 Vuepress:</li></ol><div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token function">npm</span> <span class="token function">install</span> vuepress
