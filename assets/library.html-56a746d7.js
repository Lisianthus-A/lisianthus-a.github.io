import{_ as n,p as s,q as a,a1 as t}from"./framework-c4f3d865.js";const p={},o=t(`<h1 id="库" tabindex="-1"><a class="header-anchor" href="#库" aria-hidden="true">#</a> 库</h1><h2 id="json-server" tabindex="-1"><a class="header-anchor" href="#json-server" aria-hidden="true">#</a> JSON Server</h2><h3 id="安装" tabindex="-1"><a class="header-anchor" href="#安装" aria-hidden="true">#</a> 安装</h3><p><code>npm i json-server</code></p><h3 id="模块化使用" tabindex="-1"><a class="header-anchor" href="#模块化使用" aria-hidden="true">#</a> 模块化使用</h3><div class="language-javascript" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">const</span> jsonServer <span class="token operator">=</span> <span class="token function">require</span><span class="token punctuation">(</span><span class="token string">&#39;json-server&#39;</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
